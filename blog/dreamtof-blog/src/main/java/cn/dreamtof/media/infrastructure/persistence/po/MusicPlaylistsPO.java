...
@NoArgsConstructor
@AllArgsConstructor
@Table(value = "music_playlists")
@Schema(name="music_playlists",description = "音乐播放列表表")
public class MusicPlaylistsPO implements Serializable, IdAudit, CreatedTimeAudit, UpdatedTimeAudit, VersionAudit{
    ...
    /** 审计显示: 播放列表名称 */
    @Schema(description = "审计显示: 播放列表名称")
    public static final String SHOW_NAME = "name";

    /** 审计显示: 播放列表描述 */
    @Schema(description = "审计显示: 播放列表描述")
