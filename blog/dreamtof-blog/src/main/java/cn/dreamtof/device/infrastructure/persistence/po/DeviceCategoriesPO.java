...
@NoArgsConstructor
@AllArgsConstructor
@Table(value = "device_categories")
@Schema(name="device_categories",description = "设备分类表")
public class DeviceCategoriesPO implements Serializable, IdAudit, CreatedTimeAudit, UpdatedTimeAudit, VersionAudit{
