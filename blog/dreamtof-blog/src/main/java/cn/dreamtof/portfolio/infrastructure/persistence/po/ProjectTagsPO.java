...
@NoArgsConstructor
@AllArgsConstructor
@Table(value = "project_tags")
@Schema(name="project_tags",description = "项目标签关联表")
public class ProjectTagsPO implements Serializable, IdAudit, CreatedTimeAudit, VersionAudit{
    ...
    /** 审计显示: 标签名称 */
    @Schema(description = "审计显示: 标签名称")
    public static final String SHOW_TAGNAME = "tagName";
