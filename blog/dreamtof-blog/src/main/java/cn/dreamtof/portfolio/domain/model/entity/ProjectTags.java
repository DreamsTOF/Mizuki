...
@AllArgsConstructor
@Slf4j
@Schema(name = "ProjectTags", description = "项目标签关联表 领域实体")
public class ProjectTags implements Serializable {
    ...
    public static ProjectTags create(UUID projectId, String tagName) {
        Asserts.notNull(projectId, "项目ID不能为空");
        Asserts.notBlank(tagName, "标签名称不能为空");
        ProjectTags entity = new ProjectTags();
