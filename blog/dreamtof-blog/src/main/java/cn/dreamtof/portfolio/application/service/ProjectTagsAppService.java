 ...
 * @since 
 */
public interface ProjectTagsAppService {
     ...
     * @return 领域实体分页结果
     */
    PageResult<ProjectTags> page(ProjectTagsPageReq pageReq);
     ...
     * @return 分页结果包装类
     */
    CursorResult<ProjectTags> seek(ProjectTagsCursorReq req);
}