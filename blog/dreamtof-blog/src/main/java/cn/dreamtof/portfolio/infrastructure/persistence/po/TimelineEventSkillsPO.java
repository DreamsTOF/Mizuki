...
@NoArgsConstructor
@AllArgsConstructor
@Table(value = "timeline_event_skills")
@Schema(name="timeline_event_skills",description = "时间线技能关联表")
public class TimelineEventSkillsPO implements Serializable, IdAudit, CreatedTimeAudit, VersionAudit{
    ...
    public static final String SHOW_SKILLNAME = "skillName";
