...
@NoArgsConstructor
@AllArgsConstructor
@Table(value = "friend_tags")
@Schema(name="friend_tags",description = "友链标签表")
public class FriendTagsPO implements Serializable, IdAudit, CreatedTimeAudit, UpdatedTimeAudit, VersionAudit{
