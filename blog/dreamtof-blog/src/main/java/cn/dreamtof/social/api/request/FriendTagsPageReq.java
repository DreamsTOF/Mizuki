...
import cn.dreamtof.social.domain.model.entity.FriendTags;   // 领域层 Entity
import cn.dreamtof.blog.social.api.request.FriendTagsPageReq;
import cn.dreamtof.social.api.request.FriendTagsCursorReq;
 ...
 * @since 2026-05-08
 */
public interface FriendTagsPageReq {
     ...
     * @return 领域实体分页结果
     */
    PageResult<FriendTags> page(FriendTagsPageReq pageReq);
     ...
     * @return 分页结果包装类
     */
    CursorResult<FriendTags> seek(FriendTagsCursorReq req);
}