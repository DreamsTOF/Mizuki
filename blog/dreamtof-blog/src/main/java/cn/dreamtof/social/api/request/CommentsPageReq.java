...
import cn.dreamtof.social.domain.model.entity.Comments;   // 领域层 Entity
import cn.dreamtof.blog.social.api.request.CommentsPageReq;
import cn.dreamtof.social.api.request.CommentsCursorReq;
 ...
 * @since 2026-05-08
 */
public interface CommentsPageReq {
     ...
     * @return 领域实体分页结果
     */
    PageResult<Comments> page(CommentsPageReq pageReq);
     ...
     * @return 分页结果包装类
     */
    CursorResult<Comments> seek(CommentsCursorReq req);
}