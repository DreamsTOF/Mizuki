...
public class FriendsController {
     ...
     */
    @PostMapping("page")
  public BaseResponse<PageResult<Friends>> page(@RequestBody FriendsPageReq pageRequest) {
     ...
     */
    @PostMapping("seek")
    public BaseResponse<CursorResult<Friends>> seek(@RequestBody FriendsCursorReq cursorReq) {
