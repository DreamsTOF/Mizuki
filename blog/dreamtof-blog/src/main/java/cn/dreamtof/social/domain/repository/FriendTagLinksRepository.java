...
import cn.dreamtof.blog.social.infrastructure.persistence.po.FriendTagLinks;
...
@Slf4j
public class FriendTagLinksRepository {
     ...
     * 查询详情
     */
    public FriendTagLinks getDetail(UUID id) {
